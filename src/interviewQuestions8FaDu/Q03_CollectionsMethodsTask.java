...
// tüm maksimum sayıları minimum sayı ile değiştir
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(arrList,Collections.reverseOrder()); // reverseOrder() buyukten kucuge descending
                                                            // sort () siralar
        ...
        Collections.rotate(arrList,3); // belirtilen listedeki ogeleri o sayi kadar kaydirir
        System.out.println("Rotate yaptiktan sonra : "+arrList);
        ...
        System.out.println("Max deger Min yapilinca : "+arrList);
